...
@Component({
    selector: 'jhi-tese-my-suffix',
    templateUrl: './tese-my-suffix.component.html'
})
export class TeseMySuffixComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: TeseMySuffix) {
        return item.id;
    }
