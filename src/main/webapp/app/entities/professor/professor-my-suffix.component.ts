...
@Component({
    selector: 'jhi-professor-my-suffix',
    templateUrl: './professor-my-suffix.component.html'
})
export class ProfessorMySuffixComponent implements OnInit, OnDestroy {

    professors: ProfessorMySuffix[];
    currentAccount: any;
    ...
    trackId(index: number, item: ProfessorMySuffix) {
        return item.id;
    }
