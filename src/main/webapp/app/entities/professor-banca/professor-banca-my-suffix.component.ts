...
@Component({
    selector: 'jhi-professor-banca-my-suffix',
    templateUrl: './professor-banca-my-suffix.component.html'
})
export class ProfessorBancaMySuffixComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: ProfessorBancaMySuffix) {
        return item.id;
    }
