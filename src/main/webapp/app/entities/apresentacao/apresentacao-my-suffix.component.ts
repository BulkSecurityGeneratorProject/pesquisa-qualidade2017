...
@Component({
    selector: 'jhi-apresentacao-my-suffix',
    templateUrl: './apresentacao-my-suffix.component.html'
})
export class ApresentacaoMySuffixComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: ApresentacaoMySuffix) {
        return item.id;
    }
