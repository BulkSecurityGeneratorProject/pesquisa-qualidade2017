...
@Component({
    selector: 'jhi-banca-my-suffix',
    templateUrl: './banca-my-suffix.component.html'
})
export class BancaMySuffixComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: BancaMySuffix) {
        return item.id;
    }
