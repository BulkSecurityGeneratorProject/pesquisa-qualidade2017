...
@Component({
    selector: 'jhi-proposta-tese-my-suffix',
    templateUrl: './proposta-tese-my-suffix.component.html'
})
export class PropostaTeseMySuffixComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: PropostaTeseMySuffix) {
        return item.id;
    }
