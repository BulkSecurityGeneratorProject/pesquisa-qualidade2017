...
@Injectable()
export class AlunoMySuffixPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.alunoModalRef(component, new AlunoMySuffix());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    alunoModalRef(component: Component, aluno: AlunoMySuffix): NgbModalRef {
